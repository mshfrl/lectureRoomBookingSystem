...
<html>
    <head>
        ...
        <title>Student Dashboard - Lecture Room Portal</title>
        <link rel="stylesheet" type="text/css" href="style(partAdriana).css">
        <style>
            /* Custom Modal Layout for Student Dashboard */
            .student-modal {
                display: none;
                position: fixed;
                z-index: 1000;
    ...
    <body>
        ...
        <div class="dashboard-workspace">
            ...
            <div class="rooms-grid-layout" style="margin-bottom: 40px;">
                ...
                <c:if test="${empty listAvailableRooms}">
            ...
            <div class="bookings-vertical-stack">
                <c:forEach var="booking" items="${listStudentBookings}">
                    <div class="booking-card-row">
                        ...
                        <div class="booking-card-details-divider">
                            ...
                            <div style="margin-top: 4px; font-size: 13px; color: #64748b;">
                                <strong>Lecturer:</strong> ${booking.supportingLecturer}
                            </div>
                        </div>
                    </div>
                </c:forEach>

                <c:if test="${empty listStudentBookings}">
                    <div style="text-align: center; color: #94a3b8; padding: 32px 0; font-size: 14px; background: #ffffff; border: 1px dashed #e2e8f0; border-radius: 8px;">
        ...
        <div id="studentBookingModal" class="student-modal">
                ...
                <form action="StudentServlet" method="POST">
                    ...
                    <div class="modal-form-group">
                        ...
                        <select name="supportingLecturer" id="supportingLecturer" required>
                            ...
                            <option value="khairul_anuar">Dr. Khairul Anuar</option>
                        </select>
                    </div>
                    ...
                    <div class="modal-form-group">
                        ...
                        <textarea name="purpose" id="purpose" rows="3" placeholder="e.g., Discussion, Club Activity..." required></textarea>
                    </div>
        ...
        <script>
            function openStudentModal(button) {
                ...
                document.getElementById('studentBookingModal').style.display = 'flex';
            }
